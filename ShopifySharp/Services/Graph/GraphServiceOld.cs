...
namespace ShopifySharp
{
    ...
    /// </summary>
    public class GraphServiceOld : ShopifyService
    {
        /// <summary>
        /// Creates a new instance of <see cref="GraphServiceOld" />.
        /// </summary>
        /// <param name="myShopifyUrl">The shop's *.myshopify.com URL.</param>
        /// <param name="shopAccessToken">An API access token for the shop.</param>
        public GraphServiceOld(string myShopifyUrl, string shopAccessToken) : base(myShopifyUrl, shopAccessToken) { }        
